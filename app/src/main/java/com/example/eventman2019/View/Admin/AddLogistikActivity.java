...
import com.example.eventman2019.Model.Logistik;
...
public class AddLogistikActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_logistik);
    ...
    private void StoreProductInformation() {
        ...
        UploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AddLogistikActivity.this, "Error" + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
        }).addOnSuccessListener(new OnSuccessListener<com.google.firebase.storage.UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(com.google.firebase.storage.UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AddLogistikActivity.this, "Image uploaded succesfully", Toast.LENGTH_SHORT).show();
                //get Link Image
                Task<Uri> urlTask = UploadTask.continueWithTask(new Continuation<com.google.firebase.storage.UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AddLogistikActivity.this, "got the product Image url succcesfully...", Toast.LENGTH_SHORT).show();
    ...
    private void SaveProductInfoToDatabase() {
        Logistik product = new Logistik(CategoryName, saveCurrentDate,
        ...
        ProductRef.child(CategoryName).child(productRandomKey).setValue(product)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            loadingBar.dismiss();
                            Toast.makeText(AddLogistikActivity.this, "Product is added succesfully", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(AddLogistikActivity.this,AdminCategoryActivity.class);
