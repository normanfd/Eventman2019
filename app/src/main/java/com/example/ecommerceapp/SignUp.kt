    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        SignUpBtn.setOnClickListener {
            if (edtSignUpPassword.text.toString().equals(edtSignUpRePassword.text.toString())){
                ...
                val SignUpUrl = "http://10.0.2.2:80/EventmanAPI/join_new_user.php?email="+edtSignUpEmail.text.toString()+ "&username="+edtSignUpName.text.toString()+"&pass=" + edtSignUpPassword.text.toString()
